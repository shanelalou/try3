	...
	<script>
		$(document).ready(function(){
			...
			$('#grid').flexigrid({
				...
				nomsg: 'No Class Load.',
				title: 'UPLOAD CLASS LOAD : <span>AY: <?php echo enlistment('ay').' '.enlistment('sem') ?></span><div style="float:right"><a href="CLASS LOAD FORMAT.csv" style="font-weight:normal">DOWNLOAD FORMAT</a></div>',
				height: windowHeight
			});
